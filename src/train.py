...
from prepare_dataset import id2label, label2id, label2name, preprocess, get_raw_datasets, data_collator
...
def compute_metrics()-> dict:
    ...
    for metric in metrics:
        ...
        m = list(r.keys())[0]
        result[m] = {label2name[id2label[i]]: v for i, v in enumerate(r[m])}
    return result
