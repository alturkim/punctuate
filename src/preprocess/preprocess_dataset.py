...
def preprocess(list_file_names: List[str], src_data_home:str="../../data/clean", dst_data_home:str="../../data/processed") -> None:
    """
...
if __name__ == "__main__":
    ...
    list_file_names = [file_name.split("/")[-1] for file_name in glob.glob("../../data/clean/*.txt")]
